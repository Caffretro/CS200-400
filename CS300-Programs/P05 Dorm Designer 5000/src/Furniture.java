...
public class Furniture implements DormGUI{
    ...
    public Furniture(String item, PApplet processing){
        ...
        this.item = item;
        image = processing.loadImage("images/" + item + ".png");//load bed image
        isDragging = false;
    ...
    public Furniture(String item, float x, float y, int rot, PApplet processing) 
                                                    throws NullPointerException{
        //Overloading the constructor for LoadButton
        this.processing = processing;
        this.item = item;
        image = processing.loadImage("images/" + item + ".png");//load bed image
        isDragging = false;
    ...
    public void mouseDown(Furniture[] fur) {
        if (isMouseOver()) {
            isDragging = true;
        }
    }
    ...
    public String getInfo() {
        String info;
        info = this.position[0] + ", " + this.position[1] + ", " + this.rotations;
        return info;
    }
}
